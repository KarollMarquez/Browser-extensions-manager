    ...
    <div className={`${theme} app`}>
      <div>
        ...
        <div className={`attribution theme-${theme}`}>
          <p>Challenge by <a href="https://www.frontendmentor.io/challenges/browser-extension-manager-ui-yNZnOfsMAp">Frontend Mentor</a>.</p>
          <p>Coded by <a href="https://github.com/KarollMarquez">Karoll Marquez</a>.</p>
        </div>
      </div>
    </div>
  )
